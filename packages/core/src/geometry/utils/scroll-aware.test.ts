...
describe('Scroll-Aware Geometry', () => {
    ...
    function setupSpatialSimulation(el: HTMLElement, config: {
        ...
        Object.defineProperty(el, 'clientWidth', { value: config.clientWidth ?? 100, configurable: true });
        Object.defineProperty(el, 'clientHeight', { value: config.clientHeight ?? 100, configurable: true });
        Object.defineProperty(el, 'scrollLeft', { value: config.scrollLeft ?? 0, configurable: true, writable: true });
        Object.defineProperty(el, 'scrollTop', { value: config.scrollTop ?? 0, configurable: true, writable: true });
        ...
        Object.defineProperty(el, 'offsetParent', { value: config.offsetParent ?? null, configurable: true });
    ...
    describe('Sticky Matrix', () => {
        it('should accurately deduce sticky configuration (Top Stick)', () => {
            ...
            setupSpatialSimulation(container, { clientHeight: 1000, rect: { top: 0, left: 0, height: 1000, width: 500 } });
    ...
    describe('Fixed Position & Containing Blocks (Exotic CSS)', () => {
        it('should detect when fixed element is in a transformed ancestor', () => {
            ...
            setupSpatialSimulation(transformed, { styles: { transform: 'scale(1)', position: 'static' } });
    ...
    describe('Visibility Clipping & Pruning', () => {
        it('should detect when partially visible (Bounding Edge Case)', () => {
            ...
            const item = {
                element: container, initialScrollLeft: 0, initialScrollTop: 0,
    ...
    describe('Hierarchy & Context Utilities', () => {
        ...
        it('should calculate common visibility window between elements in distinct hierarchies', () => {
            ...
            const mainState = {
                element: mainShared, initialScrollLeft: 0, initialScrollTop: 0,
                containerRect: new DOMRect(0, 0, 800, 800)
            };

            const h1 = [
                { element: section1 as HTMLElement, initialScrollLeft: 0, initialScrollTop: 0, containerRect: new DOMRect(10, 10, 100, 100) },
                mainState
            ];
            const h2 = [
                { element: section2 as HTMLElement, initialScrollLeft: 0, initialScrollTop: 0, containerRect: new DOMRect(200, 200, 100, 100) },
                mainState
            ];
        ...
        it('should handle elements inside nested shared scrollable containers (Intersection Math)', () => {
            ...
            const h1 = [{
                element: sharedContainer, initialScrollLeft: 0, initialScrollTop: 0,
        ...
        it('should clamp viewport points to live geometry bounds', () => {
            const geo = {
                ...
                clipPath: '', isHidden: false,
                visibleMinX: 10, visibleMaxX: 90,
                visibleMinY: 10, visibleMaxY: 90
            };
