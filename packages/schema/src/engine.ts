...
export type EngineRpcRequest = z.infer<typeof EngineRpcRequestSchema>;

export function isEngineRpcRequest(value: unknown): value is EngineRpcRequest {
  return EngineRpcRequestSchema.safeParse(value).success;
}
