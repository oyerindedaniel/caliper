...
describe('WalkEngine Verification - Industrial Scenarios', () => {
    ...
    const BASE_RECT: MockRect = { top: 0, left: 0, width: 100, height: 100, bottom: 100, right: 100, x: 0, y: 0 };
    ...
    it('should respect padding-aware inset offsets (Real World: Inset Content)', () => {
        ...
        setElementLayout('#parent', { top: 100, left: 100, width: 500, height: 500 }, {
            paddingTop: '50px', paddingLeft: '50px'
        });
