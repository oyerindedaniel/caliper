                ...
                <div className={styles.builtByLeft}>
                    ...
                    <div className={styles.builtByInfo}>
                        ...
                        <p className={styles.builtByText}>
                            Caliper was built because you can’t audit a system if you’re not sure of the truth.
                            We solve for the geometric edge cases—fragmented stacking contexts, recursive scroll hierarchies, and subpixel rounding—that standard tools simply ignore.
                        </p>
                    </div>
                </div>
            </div>
