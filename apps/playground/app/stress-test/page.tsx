export default function StressTestPage() {
  return (
    <div style={{ minHeight: "200vh", background: "#f5f5f5" }}>
      ...
      <main
        style={{ padding: "40px", display: "grid", gridTemplateColumns: "1fr 300px", gap: "40px" }}
      >
        <div style={{ display: "flex", flexDirection: "column", gap: "60px" }}>
          ...
          >
            ...
            >
              <div style={{ height: "1000px", padding: "20px", position: "relative" }}>
                ...
                <div id="sticky-bottom-target" style={{ height: "40px", background: "#ddd" }}>
                  Target at bottom
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div style={{ display: "flex", gap: "20px" }}>
              ...
              <div>
                <p>
                  Testing measurement to image boundaries with <code>object-fit: cover</code>.
                </p>
              </div>
            </div>
          </section>
        ...
        <aside style={{ position: "relative" }}>
          ...
          >
            ...
            <p style={{ fontSize: "14px", color: "#666" }}>
              This panel is <code>fixed</code>. Measuring from here to elements within the scrolling
              main area is a classic coordinate system stress test.
            </p>
            <div
              id="fixed-target"
              style={{
